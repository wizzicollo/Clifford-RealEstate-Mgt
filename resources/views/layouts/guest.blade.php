...
<body>
    ...
    <div class="font-sans text-green-900 antialiased min-h-screen">
        {{ $slot }}
    </div>
    <footer class="bg-white-800 border-t border-green-200">
        <div class="container flex flex-wrap items-center justify-center px-4 py-8 mx-auto lg:justify-between">
            <div class="flex flex-wrap justify-center">
                <ul class="flex items-center font-bold text-green-500 space-x-4 text-white">
                    <li>Home</li>
                    <li>About</li>
                    <li>Contact</li>
                    <li>Terms</li>
